...
`solid-stats/agent-instructions`, loaded by the managed bridge above.
Stack-specific skills live in the `solid-stats/skills` repo
(`solidstats-shared-project-standards` and the
