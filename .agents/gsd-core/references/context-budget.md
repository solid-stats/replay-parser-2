...
The keys live in `.claude/settings.json` (project) or `/home/afgan0r/Projects/SolidGames/replay-parser-2/.claude/settings.json` (global) — **not** in `.planning/config.json`:
