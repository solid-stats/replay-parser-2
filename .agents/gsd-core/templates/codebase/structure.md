...
- Usage: Reference from command with `@/home/afgan0r/Projects/SolidGames/replay-parser-2/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/afgan0r/Projects/SolidGames/replay-parser-2/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/afgan0r/Projects/SolidGames/replay-parser-2/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
