...
<required_reading>
Read `/home/afgan0r/Projects/SolidGames/replay-parser-2/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
