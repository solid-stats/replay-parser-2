...
| INT-01 | Treat Solid Stats as parser, backend, and web apps. | `replay-parser-2`, `server-2`, and `web` responsibilities are documented in AGENTS.md, README, and gsd-briefs. [VERIFIED: `AGENTS.md` + `README.md` + `gsd-briefs/*.md`] |
...
| INT-03 | Apply product-wide GSD workflow rules across apps. | All three gsd-briefs repeat AI+GSD workflow, clean git, pushback, and compatibility standards. [VERIFIED: `gsd-briefs/replay-parser-2.md` + `gsd-briefs/server-2.md` + `gsd-briefs/web.md`] |
