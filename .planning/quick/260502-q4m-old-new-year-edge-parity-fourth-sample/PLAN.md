...
# Quick Task: Old/New Year-Edge Replay Parity Fourth Sample

Run a fourth deterministic old-vs-new comparison sample using the same
year-edge policy as the prior parity samples.

## Constraints

- Use deterministic sample seed `260502-q4m`.
...
- [x] Run the fourth sample against `sg`, `mace`, and `sm` replay rows from
