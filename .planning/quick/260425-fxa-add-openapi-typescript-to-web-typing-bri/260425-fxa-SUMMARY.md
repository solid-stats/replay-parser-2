...
- Updated `replay-parser-2` brief to call out parser-contract changes that affect downstream API schema and generated frontend types.
- Synchronized the three updated briefs across `replay-parser-2`, `server-2`, and `web`.
