...
- Benchmarks against the pinned legacy parser baseline, targeting roughly 10x faster parsing on comparable workloads, including whole-list/corpus parsing rather than only one-replay timings.
